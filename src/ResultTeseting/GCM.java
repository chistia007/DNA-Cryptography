...
public class GCM {
    ...
    public static void main(String[] args) throws Exception {
        // remove if it has any extra empty lines and spaces
        String en= CipherText2Image.readDecryptedText();
        en=en.replaceAll("\\s+","");
        en=en.replaceAll("\\n+","");
        String plainText = encrypt("11","en") ;
        System.out.println("Encrypted: " + plainText);
        String de=CipherText2Image.readDecryptedText();
        de=de.replaceAll("\\s+","");
        de=de.replaceAll("\\n+","");
        String decryptedText = decrypt(plainText, "11");
